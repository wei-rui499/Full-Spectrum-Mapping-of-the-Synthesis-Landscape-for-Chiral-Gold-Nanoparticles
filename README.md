...
**Interactive UMAP viewer:** An interactive version of the
...
├── docs/
│   └── interactive_umap.html          # A map of the UMAP topological manifold structure associated with the SEM images
```
