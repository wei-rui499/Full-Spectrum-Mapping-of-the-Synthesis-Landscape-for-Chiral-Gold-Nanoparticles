"""
SI Figure S18 — FDTD cross-scale validation of the d4L empirical descriptor.

Six-panel figure (3x2) validating the d4L descriptor across FDTD simulations
(n=50) and experimental measurements (n=15).
...
from journal_style import (
    ...
    CLUSTER_COLORS_4, SINGLE_COL, DOUBLE_COL,
