...
def load_data():
    ...
    # The raw CSV stores GSH in mM (0.001-0.010); the manuscript reports GSH
    # in µM. Use µM downstream so plotted axes and Methods units agree.
    params["GSH"] = params["GSH"].astype(float) * 1000.0
